...
function wj(c){var a,b,d;a=lj(c.f);oj(c.f);b=null;if(pi(a,17)){b=Di(new Ci(),oi(a,17));}else{}if(b!==null){d=ih;if(d!==null){eS(d,b);}}zj(c,false);yj(c);}
...
function cn(e,d){var a,c;try{dn(e);}catch(a){a=zi(a);if(pi(a,16)){c=a;eS(d,c);}else throw a;}}
...
function ok(e,d,g,f){Fj();var a,c;try{pk(e,d,g);}catch(a){a=zi(a);if(pi(a,16)){c=a;eS(f,c);}else throw a;}}
...
function um(e,d){tm();var a,c;try{vm(e);}catch(a){a=zi(a);if(pi(a,16)){c=a;eS(d,c);}else throw a;}}
...
function rn(d){on();var a,c;try{sn();}catch(a){a=zi(a);if(pi(a,16)){c=a;eS(d,c);}else throw a;}}
function sn(){on();var a,b;for(a=rI(qn);gI(a);){b=oi(hI(a),21);b.xc();}}
function tn(d){on();var a,c;try{return un();}catch(a){a=zi(a);if(pi(a,16)){c=a;eS(d,c);return null;}else throw a;}}
function un(){on();var a,b,c,d;d=null;for(a=rI(qn);gI(a);){b=oi(hI(a),21);c=b.yc();{d=c;}}return d;}
function vn(d){on();var a,c;try{wn();}catch(a){a=zi(a);if(pi(a,16)){c=a;eS(d,c);}else throw a;}}
...
function xO(i,d,e,a,b){var c,f,g,h,j;h=vQ(new uQ(),sF(d.a,e.a),sF(d.b,e.b));j=pF(d.a-e.a);c=pF(d.b-e.b);g=rF(j,c);g=rF(g,pF(d.a-a.a));g=rF(g,pF(d.b-a.b));g=rF(g,pF(e.a-b.a));g=rF(g,pF(e.b-b.b));f=vQ(new uQ(),h.a-g,h.b-g);Dl(i.a,'left',mF(f.a));Dl(i.a,'top',mF(f.b));wl(i.a,'width',mF(j+g*2));wl(i.a,'height',mF(c+g*2));Dl(i.a,'width',mF(j+g*2));Dl(i.a,'height',mF(c+g*2));wO(i,yQ(d,AQ(f)),yQ(e,AQ(f)),yQ(a,AQ(f)),yQ(b,AQ(f)),zO(i.a,'color'));}
...
function DO(c,d){var a,b;CO(c);iK(c.c,d);cP(c,c.B());for(b=rI(c.c);gI(b);){a=oi(hI(b),35);a.x(c);}return c;}
function EO(a,b){DO(a,dL(b));return a;}
function aP(a){return a.b.u(a.c);}
function bP(c,a){var b;b=pK(c.c,a);if(b>(-1)){tK(c.c,a);FQ(a,c);}}
function cP(b,a){b.b=a;}
function dP(a){a.gd(aP(a));}
function eP(){var a,b;for(b=sI(this.c);b.wb();){a=oi(b.Eb(),35);b.Ac();a.D(this);}CC(this);}
function fP(){dP(this);}
function BO(){}
_=BO.prototype=new kC();_.Ac=eP;_.fd=fP;_.tN=lO+'AbstractConnection';_.tI=134;_.b=null;function hP(a){a.a=uO(new sO());}
function jP(a,b){EO(a,b);hP(a);if(b.a!=2){throw CE(new BE(),'Need exactly two connectors to connect');}a.Ec(a.a.a);kB(a,'gwt-diagrams-connection');return a;}
function iP(c,a,b){jP(c,ji('[Lpl.balon.gwt.diagrams.client.connector.Connector;',169,35,[a,b]));return c;}
function lP(){return new CP();}
function mP(){return this.a.a;}
function nP(b){var a;if(!pi(b,40)){throw CE(new BE(),'Expected BezierConnectionData');}a=oi(b,40);if(a.b.b!=2){throw CE(new BE(),'Expected two connection points');}if(a.a.b!=2){throw CE(new BE(),'Expected two control points');}xO(this.a,oi(oK(a.b,0),34),oi(oK(a.b,1),34),oi(oK(a.a,0),34),oi(oK(a.a,1),34));}
function gP(){}
_=gP.prototype=new BO();_.B=lP;_.jb=mP;_.gd=nP;_.tN=lO+'BezierTwoEndedConnection';_.tI=135;function qP(a){a.a=hK(new fK());}
function sP(a,b){EO(a,b);qP(a);if(b.a!=2){throw CE(new BE(),'Need exactly two connectors to connect');}a.Ec(ek());kB(a,'gwt-diagrams-connection');return a;}
function rP(c,a,b){sP(c,ji('[Lpl.balon.gwt.diagrams.client.connector.Connector;',169,35,[a,b]));return c;}
function uP(d,a){var b,c;for(c=d.a.b;c<a;c++){b=ek();jK(d.a,wi(b,gm));bk(d.jb(),b);Bl(b,'&nbsp;');}while(d.a.b>a){b=oi(oK(d.a,0),19);tK(d.a,wi(b,gm));rl(d.jb(),b);}}
function vP(){return new bQ();}
function wP(a){var b,c,d,e,f;if(a.b.b<=1){throw CE(new BE(),'Too few connection points');}uP(this,a.b.b-1);for(d=0;d<this.a.b;d++){b=oi(oK(this.a,d),19);e=oi(oK(a.b,d),34);c=oi(oK(a.b,d+1),34);f='gwt-diagrams-line';wl(b,'style','');zl(b,'className',f);Dl(b,'height','1');Dl(b,'width','1');if(e.a==c.a){f+=' gwt-diagrams-line-vertical';Dl(b,'height',mF(pF(e.b-c.b)));}else if(e.b==c.b){Dl(b,'width',mF(pF(e.a-c.a)));f+=' gwt-diagrams-line-horizontal';}Dl(b,'left',mF(sF(e.a,c.a)));Dl(b,'top',mF(sF(e.b,c.b)));zl(b,'className',f);}}
function pP(){}
_=pP.prototype=new BO();_.B=vP;_.gd=wP;_.tN=lO+'RectilinearTwoEndedConnection';_.tI=136;function yP(c,a,b){iP(c,a,b);return c;}
function AP(){return new hQ();}
function BP(a){if(a.b.b!=2){throw CE(new BE(),'Expected two connection points');}xO(this.a,oi(oK(a.b,0),34),oi(oK(a.b,1),34),oi(oK(a.b,1),34),oi(oK(a.b,0),34));}
function xP(){}
_=xP.prototype=new gP();_.B=AP;_.gd=BP;_.tN=lO+'StraightTwoEndedConnection';_.tI=137;function EP(j,d,e){var a,b,c,f,g,h,i;f=d.gb();g=e.gb();c=ii('[Lpl.balon.gwt.diagrams.client.connector.Direction;',[171],[37],[2],null);b=1.7976931348623157E308;for(h=0;h<f.a;h++){for(i=0;i<g.a;i++){a=xQ(d.db(f[h]),e.db(g[i]));if(a<b){b=a;c[0]=f[h];c[1]=g[i];}}}return c;}
function FP(e){var a,b,c,d,f,g,h,i;if(e.b!=2){throw CE(new BE(),'Unsupported connectors count');}c=oi(oK(e,0),35);d=oi(oK(e,1),35);f=EP(this,c,d);h=c.zc(f[0]);i=d.zc(f[1]);a=zQ(h,f[0],50);b=zQ(i,f[1],50);g=nQ(new kQ(),ji('[Lpl.balon.gwt.diagrams.client.connection.data.Point;',167,34,[h,i]),ji('[Lpl.balon.gwt.diagrams.client.connection.data.Point;',167,34,[a,b]));return g;}
function CP(){}
_=CP.prototype=new eG();_.u=FP;_.tN=mO+'BezierConnectionCalculator';_.tI=138;function cQ(e,a,c,d,b){if(b){if(c==0&&d>0){return a!==(kR(),nR);}if(c==1&&d>0){return a!==(kR(),oR);}if(c==0&&d<0){return a!==(kR(),oR);}if(c==1&&d<0){return a!==(kR(),nR);}}else{if(c==0&&d>0){return a!==(kR(),pR);}if(c==1&&d>0){return a!==(kR(),mR);}if(c==0&&d<0){return a!==(kR(),mR);}if(c==1&&d<0){return a!==(kR(),pR);}}return false;}
function eQ(j,d,e){var a,b,c,f,g,h,i;f=d.gb();g=e.gb();c=ii('[Lpl.balon.gwt.diagrams.client.connector.Direction;',[171],[37],[2],null);b=1.7976931348623157E308;for(h=0;h<f.a;h++){for(i=0;i<g.a;i++){a=xQ(d.db(f[h]),e.db(g[i]));if(a<b){b=a;c[0]=f[h];c[1]=g[i];}}}return c;}
...
function gQ(c){var a,b,d,e,f,g,h,i,j,k,l,m;if(c.b!=2){throw CE(new BE(),'Unsupported connectors count');}a=oi(oK(c,0),35);b=oi(oK(c,1),35);d=rQ(new pQ());e=eQ(this,a,b);i=a.zc(e[0]);j=zQ(i,e[0],10);k=b.zc(e[1]);l=zQ(k,e[1],10);f=l.a-j.a;m=l.b-j.b;g=null;h=null;if(fQ(this,e[0],0,f,true)&&fQ(this,e[1],1,f,true)){g=zQ(j,e[0],pF(si(f/2)));h=vQ(new uQ(),g.a,l.b);}else if(fQ(this,e[0],0,m,false)&&fQ(this,e[1],1,m,false)){g=zQ(j,e[0],pF(si(m/2)));h=vQ(new uQ(),l.a,g.b);}else if(fQ(this,e[0],0,f,true)&&fQ(this,e[1],1,m,false)){g=zQ(j,e[0],pF(f));h=zQ(l,e[1],pF(m));}else if(fQ(this,e[0],0,m,false)&&fQ(this,e[1],1,f,true)){g=zQ(j,e[0],pF(m));h=zQ(l,e[1],pF(f));}else if(fQ(this,e[0],0,f,true)&&cQ(this,e[1],1,f,true)){g=zQ(j,e[0],pF(si(f/2)));h=vQ(new uQ(),g.a,l.b);}else if(cQ(this,e[0],0,f,true)&&fQ(this,e[1],1,f,true)){h=zQ(l,e[1],pF(si(f/2)));g=vQ(new uQ(),h.a,j.b);}else if(fQ(this,e[0],0,m,false)&&cQ(this,e[1],1,m,false)){g=zQ(j,e[0],pF(si(m/2)));h=vQ(new uQ(),l.a,g.b);}else if(cQ(this,e[0],0,m,false)&&fQ(this,e[1],1,m,false)){h=zQ(l,e[1],pF(si(m/2)));g=vQ(new uQ(),j.a,h.b);}else if(cQ(this,e[0],0,f,true)&&cQ(this,e[1],1,f,true)){g=zQ(j,(kR(),oR),si(f/2));h=vQ(new uQ(),g.a,l.b);}else if(cQ(this,e[0],0,m,false)&&cQ(this,e[1],1,m,false)){g=zQ(j,(kR(),mR),si(m/2));h=vQ(new uQ(),l.a,g.b);}else if(cQ(this,e[0],0,f,true)&&cQ(this,e[1],1,m,false)){g=zQ(j,(kR(),oR),f);}else if(cQ(this,e[0],0,m,false)&&cQ(this,e[1],1,f,true)){g=zQ(j,(kR(),mR),m);}jK(d.b,i);jK(d.b,j);if(g!==null){jK(d.b,g);}if(h!==null){jK(d.b,h);}jK(d.b,l);jK(d.b,k);return d;}
function bQ(){}
_=bQ.prototype=new eG();_.u=gQ;_.tN=mO+'FullRectilinearTwoEndedCalculator';_.tI=139;function jQ(e){var a,b,c,d,f,g,h,i,j,k;if(e.b!=2){throw CE(new BE(),'Unsupported connectors count');}a=oi(oK(e,0),35);b=oi(oK(e,1),35);f=rQ(new pQ());c=vQ(new uQ(),a.nb()+si(a.tb()/2),a.rb()+si(a.kb()/2));d=vQ(new uQ(),b.nb()+si(b.tb()/2),b.rb()+si(b.kb()/2));g=vQ(new uQ(),d.a-c.a,d.b-c.b);i=g.a>=0?(-1):1;k=g.b>=0?(-1):1;j=si(a.kb()/2);h=g.b!=0?si(j*g.a/pF(g.b)):2147483647;j*= -k;if(pF(h)>si(a.tb()/2)){h=si(a.tb()/2);j=g.a!=0?si(h*g.b/pF(g.a)):2147483647;h*= -i;}jK(f.b,vQ(new uQ(),c.a+h,c.b+j));j=si(b.kb()/2);h=g.b!=0?si(j*g.a/pF(g.b)):2147483647;j*=k;h= -h;if(pF(h)>si(b.tb()/2)){h=si(b.tb()/2);j=g.a!=0?si(h*g.b/pF(g.a)):2147483647;h*=i;j= -j;}jK(f.b,vQ(new uQ(),d.a+h,d.b+j));return f;}
function hQ(){}
_=hQ.prototype=new eG();_.u=jQ;_.tN=mO+'StraightCenterConnectionDataCalculator';_.tI=140;function qQ(a){a.b=hK(new fK());}
function rQ(a){qQ(a);return a;}
function sQ(b,a){qQ(b);iK(b.b,a);return b;}
function pQ(){}
_=pQ.prototype=new eG();_.tN=nO+'ConnectionData';_.tI=141;function lQ(a){a.a=hK(new fK());}
function mQ(c,b,a){sQ(c,b);lQ(c);iK(c.a,a);return c;}
function nQ(c,b,a){mQ(c,dL(b),dL(a));return c;}
function kQ(){}
_=kQ.prototype=new pQ();_.tN=nO+'BezierConnectionData';_.tI=142;function vQ(b,a,c){b.a=a;b.b=c;return b;}
function xQ(b,a){return tF((b.a-a.a)*(b.a-a.a)+(b.b-a.b)*(b.b-a.b));}
function zQ(c,a,b){if(a===(kR(),mR)){return vQ(new uQ(),c.a,c.b+b);}else if(a===(kR(),pR)){return vQ(new uQ(),c.a,c.b-b);}else if(a===(kR(),nR)){return vQ(new uQ(),c.a-b,c.b);}else if(a===(kR(),oR)){return vQ(new uQ(),c.a+b,c.b);}else{throw FE(new EE());}}
function yQ(a,b){return vQ(new uQ(),a.a+b.a,a.b+b.b);}
function AQ(a){return vQ(new uQ(),-a.a,-a.b);}
function uQ(){}
_=uQ.prototype=new eG();_.tN=nO+'Point';_.tI=143;_.a=0;_.b=0;function CQ(a){a.c=iN(new hN());}
function DQ(a){CQ(a);return a;}
function FQ(b,a){if(mN(b.c,a)){bP(a,b);}}
function aR(b,a){return zQ(vQ(new uQ(),b.nb()+si(b.tb()/2),b.rb()+si(b.kb()/2)),a,lR(a)?si(b.tb()/2):si(b.kb()/2));}
function bR(c){var a,b;for(b=lN(c.c);eJ(b);){a=oi(fJ(b),41);a.fd();}}
function cR(a){jN(this.c,a);}
function dR(a){FQ(this,a);}
function eR(a){return aR(this,a);}
function fR(){return qR();}
function gR(a){return aR(this,a);}
function BQ(){}
_=BQ.prototype=new eG();_.x=cR;_.D=dR;_.db=eR;_.gb=fR;_.zc=gR;_.tN=oO+'AbstractConnector';_.tI=144;function kR(){kR=CN;pR=jR(new iR(),'UP');mR=jR(new iR(),'DOWN');nR=jR(new iR(),'LEFT');oR=jR(new iR(),'RIGHT');}
function jR(b,a){kR();b.a=a;return b;}
function lR(a){return a===nR||a===oR;}
function qR(){kR();return ji('[Lpl.balon.gwt.diagrams.client.connector.Direction;',171,37,[pR,mR,nR,oR]);}
function rR(){return this.a;}
function iR(){}
_=iR.prototype=new eG();_.tS=rR;_.tN=oO+'Direction';_.tI=145;_.a=null;var mR,nR,oR,pR;function yR(){yR=CN;aS=oM(new sL());}
function xR(a,b){yR();DQ(a);a.b=b;return a;}
function zR(){return this.b.ob();}
function AR(){var a,b;a=0;b=kl(this.b.jb());while(b!==null){if(AG('relative',ll(b,'position'))){a=al(b);break;}b=kl(b);}return mB(this.b)-a;}
function BR(){var a,b;a=0;b=kl(this.b.jb());while(b!==null){if(AG('relative',ll(b,'position'))){a=bl(b);break;}b=kl(b);}return nB(this.b)-a;}
function CR(){return this.b.pb();}
function DR(a){yR();return oi(uM(aS,a),42);}
function ER(b){yR();var a;if(rM(aS,b)){return oi(uM(aS,b),42);}else{a=xR(new sR(),b);vM(aS,b,a);return a;}}
function FR(c,b){yR();var a;if(rM(aS,c)){return oi(uM(aS,c),42);}else{a=uR(new tR(),c,b);vM(aS,c,a);return a;}}
function sR(){}
_=sR.prototype=new BQ();_.kb=zR;_.nb=AR;_.rb=BR;_.tb=CR;_.tN=oO+'UIObjectConnector';_.tI=146;_.b=null;var aS;function vR(){vR=CN;yR();}
function uR(b,a,c){vR();b.a=c;xR(b,a);return b;}
function wR(){return this.a;}
function tR(){}
_=tR.prototype=new sR();_.gb=wR;_.tN=oO+'UIObjectConnector$1';_.tI=147;function kS(e,a){a=a.replace(/[\[]/,'\\[').replace(/[\]]/,'\\]');var c='[\\?&]'+a+'=([^&#]*)';var b=new RegExp(c);var d=b.exec($wnd.location.href);if(d==null)return '';else return d[1];}
function lS(a){jh(new cS());em(gS(new fS(),a));}
function bS(){}
_=bS.prototype=new eG();_.tN=pO+'BaseExamplesEntryPoint';_.tI=148;function eS(e,f){var a,b,c,d;d='Uncaught exception: ';while(f!==null){c=f.c;d+=wH(f)+'\n';for(b=0;b<c.a;b++){d+='    at '+c[b]+'\n';}f=f.a;if(f!==null){d+='Caused by: ';}}a=ms(new ks(),true);Dl(a.jb(),'backgroundColor','#ABCDEF');nH(),pH;d=FG(d,' ','&nbsp;');ps(a,'<pre>'+d+'<\/pre>');Ex(a);}
function cS(){}
_=cS.prototype=new eG();_.tN=pO+'BaseExamplesEntryPoint$1';_.tI=149;function gS(b,a){b.a=a;return b;}
function iS(){tS(this.a);}
function fS(){}
_=fS.prototype=new eG();_.bb=iS;_.tN=pO+'BaseExamplesEntryPoint$2';_.tI=150;function tS(c){var a,b;b=DA(new qA());mq(cz('tabs'),b);FA(b,CU(new BU()),'Rectilinear');FA(b,uT(new tT()),'Bezier');FA(b,aV(new FU()),'Straight');FA(b,oU(new xT()),'Diagram builder');EA(b,oS(new nS(),c,b));a=kS(c,'tab');if(a===null||AG('',a)){a='0';}eB(b,kF(a));}
function mS(){}
_=mS.prototype=new bS();_.tN=pO+'GwtDiagramsExample';_.tI=151;function oS(b,a,c){b.a=c;return b;}
function qS(a,b){return true;}
function rS(b,c){var a;a=oi(bB(this.a,c),43);lT(a);}
function nS(){}
_=nS.prototype=new eG();_.bc=qS;_.vc=rS;_.tN=pO+'GwtDiagramsExample$1';_.tI=152;function pT(a){a.i=lq(new kq());}
function qT(a){var b;mz(a);pT(a);kB(a,'gwt-diagrams-example');b=eC(new cC());oz(a,b);fC(b,a.i);fC(b,sT(a,kT(a)));return a;}
function sT(e,d){var a,b,c;a=gt(new ft());kB(a,'gwt-diagrams-sources-panel');for(b=rI(d);gI(b);){c=oi(hI(b),14);ht(a,c);}return a;}
function oT(){}
_=oT.prototype=new fz();_.tN=qO+'AbstractExample';_.tI=153;function dT(a){a.g=hK(new fK());}
function eT(a){qT(a);dT(a);a.h=iT(a);Dl(a.i.jb(),'width','450px');Dl(a.i.jb(),'height','350px');a.C();return a;}
function fT(b,a){mq(b.i,a);jK(b.g,a);}
function hT(e,d,c,f,a){var b;b=Ew(new Cw(),d);kB(b,'example-connector');nq(e.i,b,c,f);yS(e.h,b);if(a!==null){return FR(b,ji('[Lpl.balon.gwt.diagrams.client.connector.Direction;',171,37,[a]));}return ER(b);}
function iT(b){var a;a=wS(new vS(),b.i,true,b);return a;}
function jT(b,a){tK(b.g,a);}
function kT(f){var a,b,c,d,e;e=hK(new fK());b=DG(hh(f),46);a=aH(hh(f),b+1);jK(e,rw(new pw(),a+'.java',''));jK(e,rw(new pw(),'AbstractExample.java',''));jK(e,rw(new pw(),'AbstractConnectionsExample.java',''));for(d=rI(e);gI(d);){c=oi(hI(d),44);kB(c,'gwt-diagrams-source-link');sw(c,aT(new FS(),f,c));}return e;}
function lT(c){var a,b;for(b=rI(c.g);gI(b);){a=oi(hI(b),41);a.fd();}}
function mT(a){fT(this,a);}
function nT(){var a,b,c,d,e,f,g,h;a=hT(this,'all',50,50,null);b=hT(this,'all',100,100,null);this.y(a,b);c=hT(this,'up',250,50,(kR(),pR));d=hT(this,'down',300,100,(kR(),mR));this.y(c,d);e=hT(this,'left',50,200,(kR(),nR));f=hT(this,'right',100,250,(kR(),oR));this.y(e,f);g=hT(this,'left',250,200,(kR(),nR));h=hT(this,'left',300,250,(kR(),nR));this.y(g,h);}
function uS(){}
_=uS.prototype=new oT();_.t=mT;_.C=nT;_.tN=qO+'AbstractConnectionsExample';_.tI=154;_.h=null;function xS(){xS=CN;ad();}
function wS(d,a,b,c){xS();Fc(d,a,b);return d;}
function yS(a,b){A(a,b);Dl(b.jb(),'position','absolute');Dl(b.jb(),'zIndex','100');}
function zS(a){yS(this,a);}
function AS(b,a){return CS(new BS(),b,a,this);}
function vS(){}
_=vS.prototype=new Ec();_.Bb=zS;_.Db=AS;_.tN=qO+'AbstractConnectionsExample$1';_.tI=155;function DS(){DS=CN;se();}
function CS(d,a,b,c){DS();re(d,a,b);return d;}
function ES(d,c,b){var a;od(this,d,c,b);a=DR(c);if(a!==null){bR(a);}}
function BS(){}
_=BS.prototype=new qe();_.rc=ES;_.tN=qO+'AbstractConnectionsExample$2';_.tI=156;function aT(b,a,c){b.a=c;return b;}
function cT(a){Fn('../source/'+uw(this.a),'','');}
function FS(){}
_=FS.prototype=new eG();_.dc=cT;_.tN=qO+'AbstractConnectionsExample$3';_.tI=157;function uT(a){eT(a);return a;}
function wT(a,b){this.t(iP(new gP(),a,b));}
function tT(){}
_=tT.prototype=new uS();_.y=wT;_.tN=qO+'BezierExample';_.tI=158;function nU(a){a.c=hK(new fK());}
function oU(a){eT(a);nU(a);return a;}
function pU(b,a){fT(b,a);dP(a);}
function rU(c,a,b){if(AG('rectilinear',c.d)){pU(c,rP(new pP(),a,b));}else if(AG('bezier',c.d)){pU(c,iP(new gP(),a,b));}else if(AG('straight',c.d)){pU(c,yP(new xP(),a,b));}}
function sU(e,d,c){var a,b;b=fU(new eU(),cx(d),e);tB(b,d.pb(),d.ob());kB(b,'example-connector');nq(c,b,mB(d)-mB(c),nB(d)-nB(c));yS(e.h,b);a=null;if(AG('T',cx(b))){a=(kR(),pR);}else if(AG('L',cx(b))){a=(kR(),nR);}else if(AG('B',cx(b))){a=(kR(),mR);}else if(AG('R',cx(b))){a=(kR(),oR);}if(a!==null){return FR(b,ji('[Lpl.balon.gwt.diagrams.client.connector.Direction;',171,37,[a]));}return ER(b);}
function tU(c,a){var b;b=Ew(new Cw(),a);kB(b,'helpEntry');iw(c.a,b);}
function uU(d,c,a){var b;b=xy(new vy(),'style',c);kB(b,'style-option');br(b,a);if(a){xU(d,c);}iw(d.e,b);mt(b,bU(new aU(),d,c));return b;}
function vU(d,a,c){var b;b=Ew(new Cw(),a);uB(b,'toolbox-node');kB(b,c);iw(d.e,b);d.f.Bb(b);return b;}
function wU(d,e){var a,b,c,f;if(rK(d.c)){kB(e,'selected-connector');b=DR(e).c;for(c=lN(b);eJ(c);){a=oi(fJ(c),41);a.Ac();jT(d,a);}jK(d.c,e);}else if(nK(d.c,e)){qB(e,'selected-connector');tK(d.c,e);}else if(d.c.b==1){f=oi(oK(d.c,0),14);qB(e,'selected-connector');qB(f,'selected-connector');b=DR(e).c;for(c=lN(b);eJ(c);){a=oi(fJ(c),41);a.Ac();jT(d,a);}rU(d,DR(f),DR(e));lK(d.c);}}
function xU(b,a){b.d=a;}
function yU(a){pU(this,a);}
function zU(a,b){rU(this,a,b);}
function AU(){var a,b,c;a=Fc(new Ec(),this.i,true);b=jd(new id(),this.i);this.f=kU(new iU(),b,a,this);this.e=hw(new fw());uB(this.e,'toolbox');this.b=lq(new kq());this.a=hw(new fw());uB(this.a,'helpPanel');c=eC(new cC());uB(c,'builder');fC(c,this.a);fC(c,this.e);fC(c,this.b);mq(this.i,c);vU(this,'A','all');vU(this,'L','left');vU(this,'R','right');vU(this,'T','top');vU(this,'B','bottom');uU(this,'rectilinear',true);uU(this,'bezier',false);uU(this,'straight',false);tU(this,'drag&drop from toolbar to add');tU(this,'CTRL+click to select/connect');tU(this,'DEL to delete selected');ak(DT(new CT(),this));}
function xT(){}
_=xT.prototype=new uS();_.t=yU;_.y=zU;_.C=AU;_.tN=qO+'DiagramBuilderExample';_.tI=159;_.a=null;_.b=null;_.d=null;_.e=null;_.f=null;function zT(b,a,c){b.a=a;b.b=c;return b;}
function BT(a){var b,c,d;b=a.d;d=oi(uM(this.a.a,b),14);c=this.b.g;sU(this.a.b,oi(d,45),c);throw gd(new fd());}
function yT(){}
_=yT.prototype=new rb();_.sc=BT;_.tN=qO+'DiagramBuilderExample$1';_.tI=160;function DT(b,a){b.a=a;return b;}
function FT(a){var b,c;if(128==Dk(a)&&46==yk(a)&& !rK(this.a.c)){for(b=sI(this.a.c);gI(b);){c=oi(hI(b),14);iI(b);CC(c);}return false;}return true;}
function CT(){}
_=CT.prototype=new eG();_.jc=FT;_.tN=qO+'DiagramBuilderExample$2';_.tI=161;function bU(b,a,c){b.a=a;b.b=c;return b;}
function dU(a){xU(this.a,this.b);}
function aU(){}
_=aU.prototype=new eG();_.dc=dU;_.tN=qO+'DiagramBuilderExample$3';_.tI=162;function fU(c,a,b){c.a=b;Ew(c,a);return c;}
function hU(a){if(Dk(a)==1&&wk(a)){wU(this.a,this);}dx(this,a);}
function eU(){}
_=eU.prototype=new Cw();_.cc=hU;_.tN=qO+'DiagramBuilderExample$4';_.tI=163;function lU(){lU=CN;ad();}
function jU(a){a.a=oM(new sL());}
function kU(d,a,b,c){lU();d.b=c;Fc(d,d.b.i,false);jU(d);dd(d,true);F(d,a);u(d,zT(new yT(),d,a));return d;}
function mU(a){var b,c;b=oi(a,45);c=Ew(new Cw(),cx(b));kB(c,'dragdrop-proxy');kB(c,'toolbox-node-proxy');tB(c,b.pb(),b.ob());vM(this.a,b,c);return c;}
function iU(){}
_=iU.prototype=new Ec();_.Cb=mU;_.tN=qO+'DiagramBuilderExample$ToolboxDragController';_.tI=164;function CU(a){eT(a);return a;}
function EU(a,b){this.t(rP(new pP(),a,b));}
function BU(){}
_=BU.prototype=new uS();_.y=EU;_.tN=qO+'RectilinearExample';_.tI=165;function aV(a){eT(a);return a;}
function cV(c,a,b){c.t(yP(new xP(),a,b));}
function dV(a,b){cV(this,a,b);}
function eV(){var a,b;a=hT(this,'connector 1',50,50,(kR(),pR));b=hT(this,'connector 2',200,200,(kR(),mR));cV(this,a,b);}
function FU(){}
_=FU.prototype=new uS();_.y=dV;_.C=eV;_.tN=qO+'StraightConnectionsExample';_.tI=166;function AD(){lS(new mS());}
