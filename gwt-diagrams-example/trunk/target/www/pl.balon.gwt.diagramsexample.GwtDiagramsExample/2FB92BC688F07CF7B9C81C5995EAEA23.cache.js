...
function yj(c){var a,b,d;a=nj(c.f);qj(c.f);b=null;if(ri(a,17)){b=Fi(new Ei(),qi(a,17));}else{}if(b!==null){d=kh;if(d!==null){mS(d,b);}}Bj(c,false);Aj(c);}
...
function en(e,d){var a,c;try{fn(e);}catch(a){a=Bi(a);if(ri(a,16)){c=a;mS(d,c);}else throw a;}}
...
function qk(e,d,g,f){bk();var a,c;try{rk(e,d,g);}catch(a){a=Bi(a);if(ri(a,16)){c=a;mS(f,c);}else throw a;}}
...
function wm(e,d){vm();var a,c;try{xm(e);}catch(a){a=Bi(a);if(ri(a,16)){c=a;mS(d,c);}else throw a;}}
...
function tn(d){qn();var a,c;try{un();}catch(a){a=Bi(a);if(ri(a,16)){c=a;mS(d,c);}else throw a;}}
function un(){qn();var a,b;for(a=zI(sn);oI(a);){b=qi(pI(a),21);b.zc();}}
function vn(d){qn();var a,c;try{return wn();}catch(a){a=Bi(a);if(ri(a,16)){c=a;mS(d,c);return null;}else throw a;}}
function wn(){qn();var a,b,c,d;d=null;for(a=zI(sn);oI(a);){b=qi(pI(a),21);c=b.Ac();{d=c;}}return d;}
function xn(d){qn();var a,c;try{yn();}catch(a){a=Bi(a);if(ri(a,16)){c=a;mS(d,c);}else throw a;}}
...
function FO(i,d,e,a,b){var c,f,g,h,j;h=DQ(new CQ(),AF(d.a,e.a),AF(d.b,e.b));j=xF(d.a-e.a);c=xF(d.b-e.b);g=zF(j,c);g=zF(g,xF(d.a-a.a));g=zF(g,xF(d.b-a.b));g=zF(g,xF(e.a-b.a));g=zF(g,xF(e.b-b.b));f=DQ(new CQ(),h.a-g,h.b-g);Fl(i.a,'left',uF(f.a));Fl(i.a,'top',uF(f.b));yl(i.a,'width',uF(j+g*2));yl(i.a,'height',uF(c+g*2));Fl(i.a,'width',uF(j+g*2));Fl(i.a,'height',uF(c+g*2));EO(i,aR(d,cR(f)),aR(e,cR(f)),aR(a,cR(f)),aR(b,cR(f)),bP(i.a,'color'));}
...
function fP(c,d){var a,b;eP(c);qK(c.c,d);kP(c,c.D());for(b=zI(c.c);oI(b);){a=qi(pI(b),35);a.z(c);}return c;}
function gP(a,b){fP(a,lL(b));return a;}
function iP(a){return a.b.u(a.c);}
function jP(c,a){var b;b=xK(c.c,a);if(b>(-1)){BK(c.c,a);hR(a,c);}}
function kP(b,a){b.b=a;}
function lP(a){a.id(iP(a));}
function mP(){var a,b;for(b=AI(this.c);b.yb();){a=qi(b.ac(),35);b.Cc();a.F(this);}DC(this);}
function nP(){lP(this);}
function dP(){}
_=dP.prototype=new lC();_.Cc=mP;_.hd=nP;_.tN=tO+'AbstractConnection';_.tI=137;_.b=null;function pP(a){a.a=CO(new AO());}
function rP(a,b){gP(a,b);pP(a);if(b.a!=2){throw eF(new dF(),'Need exactly two connectors to connect');}a.ad(a.a.a);lB(a,'gwt-diagrams-connection');return a;}
function qP(c,a,b){rP(c,li('[Lpl.balon.gwt.diagrams.client.connector.Connector;',172,35,[a,b]));return c;}
function tP(){return new eQ();}
function uP(){return this.a.a;}
function vP(b){var a;if(!ri(b,40)){throw eF(new dF(),'Expected BezierConnectionData');}a=qi(b,40);if(a.b.b!=2){throw eF(new dF(),'Expected two connection points');}if(a.a.b!=2){throw eF(new dF(),'Expected two control points');}FO(this.a,qi(wK(a.b,0),34),qi(wK(a.b,1),34),qi(wK(a.a,0),34),qi(wK(a.a,1),34));}
function oP(){}
_=oP.prototype=new dP();_.D=tP;_.lb=uP;_.id=vP;_.tN=tO+'BezierTwoEndedConnection';_.tI=138;function yP(a){a.a=pK(new nK());}
function AP(a,b){gP(a,b);yP(a);if(b.a!=2){throw eF(new dF(),'Need exactly two connectors to connect');}a.ad(gk());lB(a,'gwt-diagrams-connection');return a;}
function zP(c,a,b){AP(c,li('[Lpl.balon.gwt.diagrams.client.connector.Connector;',172,35,[a,b]));return c;}
function CP(d,a){var b,c;for(c=d.a.b;c<a;c++){b=gk();rK(d.a,yi(b,im));dk(d.lb(),b);Dl(b,'&nbsp;');}while(d.a.b>a){b=qi(wK(d.a,0),19);BK(d.a,yi(b,im));tl(d.lb(),b);}}
function DP(){return new jQ();}
function EP(a){var b,c,d,e,f;if(a.b.b<=1){throw eF(new dF(),'Too few connection points');}CP(this,a.b.b-1);for(d=0;d<this.a.b;d++){b=qi(wK(this.a,d),19);e=qi(wK(a.b,d),34);c=qi(wK(a.b,d+1),34);f='gwt-diagrams-line';yl(b,'style','');Bl(b,'className',f);Fl(b,'height','1');Fl(b,'width','1');if(e.a==c.a){f+=' gwt-diagrams-line-vertical';Fl(b,'height',uF(xF(e.b-c.b)));}else if(e.b==c.b){Fl(b,'width',uF(xF(e.a-c.a)));f+=' gwt-diagrams-line-horizontal';}Fl(b,'left',uF(AF(e.a,c.a)));Fl(b,'top',uF(AF(e.b,c.b)));Bl(b,'className',f);}}
function xP(){}
_=xP.prototype=new dP();_.D=DP;_.id=EP;_.tN=tO+'RectilinearTwoEndedConnection';_.tI=139;function aQ(c,a,b){qP(c,a,b);return c;}
function cQ(){return new pQ();}
function dQ(a){if(a.b.b!=2){throw eF(new dF(),'Expected two connection points');}FO(this.a,qi(wK(a.b,0),34),qi(wK(a.b,1),34),qi(wK(a.b,1),34),qi(wK(a.b,0),34));}
function FP(){}
_=FP.prototype=new oP();_.D=cQ;_.id=dQ;_.tN=tO+'StraightTwoEndedConnection';_.tI=140;function gQ(j,d,e){var a,b,c,f,g,h,i;f=d.ib();g=e.ib();c=ki('[Lpl.balon.gwt.diagrams.client.connector.Direction;',[174],[37],[2],null);b=1.7976931348623157E308;for(h=0;h<f.a;h++){for(i=0;i<g.a;i++){a=FQ(d.fb(f[h]),e.fb(g[i]));if(a<b){b=a;c[0]=f[h];c[1]=g[i];}}}return c;}
function hQ(e){var a,b,c,d,f,g,h,i;if(e.b!=2){throw eF(new dF(),'Unsupported connectors count');}c=qi(wK(e,0),35);d=qi(wK(e,1),35);f=gQ(this,c,d);h=c.Bc(f[0]);i=d.Bc(f[1]);a=bR(h,f[0],50);b=bR(i,f[1],50);g=vQ(new sQ(),li('[Lpl.balon.gwt.diagrams.client.connection.data.Point;',170,34,[h,i]),li('[Lpl.balon.gwt.diagrams.client.connection.data.Point;',170,34,[a,b]));return g;}
function eQ(){}
_=eQ.prototype=new mG();_.u=hQ;_.tN=uO+'BezierConnectionCalculator';_.tI=141;function kQ(e,a,c,d,b){if(b){if(c==0&&d>0){return a!==(sR(),vR);}if(c==1&&d>0){return a!==(sR(),wR);}if(c==0&&d<0){return a!==(sR(),wR);}if(c==1&&d<0){return a!==(sR(),vR);}}else{if(c==0&&d>0){return a!==(sR(),xR);}if(c==1&&d>0){return a!==(sR(),uR);}if(c==0&&d<0){return a!==(sR(),uR);}if(c==1&&d<0){return a!==(sR(),xR);}}return false;}
function mQ(j,d,e){var a,b,c,f,g,h,i;f=d.ib();g=e.ib();c=ki('[Lpl.balon.gwt.diagrams.client.connector.Direction;',[174],[37],[2],null);b=1.7976931348623157E308;for(h=0;h<f.a;h++){for(i=0;i<g.a;i++){a=FQ(d.fb(f[h]),e.fb(g[i]));if(a<b){b=a;c[0]=f[h];c[1]=g[i];}}}return c;}
function nQ(e,a,c,d,b){if(b){if(c==0&&d>0){return a===(sR(),wR);}if(c==1&&d>0){return a===(sR(),vR);}if(c==0&&d<0){return a===(sR(),vR);}if(c==1&&d<0){return a===(sR(),wR);}}else{if(c==0&&d>0){return a===(sR(),uR);}if(c==1&&d>0){return a===(sR(),xR);}if(c==0&&d<0){return a===(sR(),xR);}if(c==1&&d<0){return a===(sR(),uR);}}return false;}
function oQ(c){var a,b,d,e,f,g,h,i,j,k,l,m;if(c.b!=2){throw eF(new dF(),'Unsupported connectors count');}a=qi(wK(c,0),35);b=qi(wK(c,1),35);d=zQ(new xQ());e=mQ(this,a,b);i=a.Bc(e[0]);j=bR(i,e[0],10);k=b.Bc(e[1]);l=bR(k,e[1],10);f=l.a-j.a;m=l.b-j.b;g=null;h=null;if(nQ(this,e[0],0,f,true)&&nQ(this,e[1],1,f,true)){g=bR(j,e[0],xF(ui(f/2)));h=DQ(new CQ(),g.a,l.b);}else if(nQ(this,e[0],0,m,false)&&nQ(this,e[1],1,m,false)){g=bR(j,e[0],xF(ui(m/2)));h=DQ(new CQ(),l.a,g.b);}else if(nQ(this,e[0],0,f,true)&&nQ(this,e[1],1,m,false)){g=bR(j,e[0],xF(f));h=bR(l,e[1],xF(m));}else if(nQ(this,e[0],0,m,false)&&nQ(this,e[1],1,f,true)){g=bR(j,e[0],xF(m));h=bR(l,e[1],xF(f));}else if(nQ(this,e[0],0,f,true)&&kQ(this,e[1],1,f,true)){g=bR(j,e[0],xF(ui(f/2)));h=DQ(new CQ(),g.a,l.b);}else if(kQ(this,e[0],0,f,true)&&nQ(this,e[1],1,f,true)){h=bR(l,e[1],xF(ui(f/2)));g=DQ(new CQ(),h.a,j.b);}else if(nQ(this,e[0],0,m,false)&&kQ(this,e[1],1,m,false)){g=bR(j,e[0],xF(ui(m/2)));h=DQ(new CQ(),l.a,g.b);}else if(kQ(this,e[0],0,m,false)&&nQ(this,e[1],1,m,false)){h=bR(l,e[1],xF(ui(m/2)));g=DQ(new CQ(),j.a,h.b);}else if(kQ(this,e[0],0,f,true)&&kQ(this,e[1],1,f,true)){g=bR(j,(sR(),wR),ui(f/2));h=DQ(new CQ(),g.a,l.b);}else if(kQ(this,e[0],0,m,false)&&kQ(this,e[1],1,m,false)){g=bR(j,(sR(),uR),ui(m/2));h=DQ(new CQ(),l.a,g.b);}else if(kQ(this,e[0],0,f,true)&&kQ(this,e[1],1,m,false)){g=bR(j,(sR(),wR),f);}else if(kQ(this,e[0],0,m,false)&&kQ(this,e[1],1,f,true)){g=bR(j,(sR(),uR),m);}rK(d.b,i);rK(d.b,j);if(g!==null){rK(d.b,g);}if(h!==null){rK(d.b,h);}rK(d.b,l);rK(d.b,k);return d;}
function jQ(){}
_=jQ.prototype=new mG();_.u=oQ;_.tN=uO+'FullRectilinearTwoEndedCalculator';_.tI=142;function rQ(e){var a,b,c,d,f,g,h,i,j,k;if(e.b!=2){throw eF(new dF(),'Unsupported connectors count');}a=qi(wK(e,0),35);b=qi(wK(e,1),35);f=zQ(new xQ());c=DQ(new CQ(),a.pb()+ui(a.vb()/2),a.tb()+ui(a.mb()/2));d=DQ(new CQ(),b.pb()+ui(b.vb()/2),b.tb()+ui(b.mb()/2));g=DQ(new CQ(),d.a-c.a,d.b-c.b);i=g.a>=0?(-1):1;k=g.b>=0?(-1):1;j=ui(a.mb()/2);h=g.b!=0?ui(j*g.a/xF(g.b)):2147483647;j*= -k;if(xF(h)>ui(a.vb()/2)){h=ui(a.vb()/2);j=g.a!=0?ui(h*g.b/xF(g.a)):2147483647;h*= -i;}rK(f.b,DQ(new CQ(),c.a+h,c.b+j));j=ui(b.mb()/2);h=g.b!=0?ui(j*g.a/xF(g.b)):2147483647;j*=k;h= -h;if(xF(h)>ui(b.vb()/2)){h=ui(b.vb()/2);j=g.a!=0?ui(h*g.b/xF(g.a)):2147483647;h*=i;j= -j;}rK(f.b,DQ(new CQ(),d.a+h,d.b+j));return f;}
function pQ(){}
_=pQ.prototype=new mG();_.u=rQ;_.tN=uO+'StraightCenterConnectionDataCalculator';_.tI=143;function yQ(a){a.b=pK(new nK());}
function zQ(a){yQ(a);return a;}
function AQ(b,a){yQ(b);qK(b.b,a);return b;}
function xQ(){}
_=xQ.prototype=new mG();_.tN=vO+'ConnectionData';_.tI=144;function tQ(a){a.a=pK(new nK());}
function uQ(c,b,a){AQ(c,b);tQ(c);qK(c.a,a);return c;}
function vQ(c,b,a){uQ(c,lL(b),lL(a));return c;}
function sQ(){}
_=sQ.prototype=new xQ();_.tN=vO+'BezierConnectionData';_.tI=145;function DQ(b,a,c){b.a=a;b.b=c;return b;}
function FQ(b,a){return BF((b.a-a.a)*(b.a-a.a)+(b.b-a.b)*(b.b-a.b));}
function bR(c,a,b){if(a===(sR(),uR)){return DQ(new CQ(),c.a,c.b+b);}else if(a===(sR(),xR)){return DQ(new CQ(),c.a,c.b-b);}else if(a===(sR(),vR)){return DQ(new CQ(),c.a-b,c.b);}else if(a===(sR(),wR)){return DQ(new CQ(),c.a+b,c.b);}else{throw hF(new gF());}}
function aR(a,b){return DQ(new CQ(),a.a+b.a,a.b+b.b);}
function cR(a){return DQ(new CQ(),-a.a,-a.b);}
function CQ(){}
_=CQ.prototype=new mG();_.tN=vO+'Point';_.tI=146;_.a=0;_.b=0;function eR(a){a.c=qN(new pN());}
function fR(a){eR(a);return a;}
function hR(b,a){if(uN(b.c,a)){jP(a,b);}}
function iR(b,a){return bR(DQ(new CQ(),b.pb()+ui(b.vb()/2),b.tb()+ui(b.mb()/2)),a,tR(a)?ui(b.vb()/2):ui(b.mb()/2));}
function jR(c){var a,b;for(b=tN(c.c);mJ(b);){a=qi(nJ(b),41);a.hd();}}
function kR(a){rN(this.c,a);}
function lR(a){hR(this,a);}
function mR(a){return iR(this,a);}
function nR(){return yR();}
function oR(a){return iR(this,a);}
function dR(){}
_=dR.prototype=new mG();_.z=kR;_.F=lR;_.fb=mR;_.ib=nR;_.Bc=oR;_.tN=wO+'AbstractConnector';_.tI=147;function sR(){sR=eO;xR=rR(new qR(),'UP');uR=rR(new qR(),'DOWN');vR=rR(new qR(),'LEFT');wR=rR(new qR(),'RIGHT');}
function rR(b,a){sR();b.a=a;return b;}
function tR(a){return a===vR||a===wR;}
function yR(){sR();return li('[Lpl.balon.gwt.diagrams.client.connector.Direction;',174,37,[xR,uR,vR,wR]);}
function zR(){return this.a;}
function qR(){}
_=qR.prototype=new mG();_.tS=zR;_.tN=wO+'Direction';_.tI=148;_.a=null;var uR,vR,wR,xR;function aS(){aS=eO;iS=wM(new AL());}
function FR(a,b){aS();fR(a);a.b=b;return a;}
function bS(){return this.b.qb();}
function cS(){var a,b;a=0;b=ml(this.b.lb());while(b!==null){if(cH('relative',nl(b,'position'))){a=cl(b);break;}b=ml(b);}return nB(this.b)-a;}
function dS(){var a,b;a=0;b=ml(this.b.lb());while(b!==null){if(cH('relative',nl(b,'position'))){a=dl(b);break;}b=ml(b);}return oB(this.b)-a;}
function eS(){return this.b.rb();}
function fS(a){aS();return qi(CM(iS,a),42);}
function gS(b){aS();var a;if(zM(iS,b)){return qi(CM(iS,b),42);}else{a=FR(new AR(),b);DM(iS,b,a);return a;}}
function hS(c,b){aS();var a;if(zM(iS,c)){return qi(CM(iS,c),42);}else{a=CR(new BR(),c,b);DM(iS,c,a);return a;}}
function AR(){}
_=AR.prototype=new dR();_.mb=bS;_.pb=cS;_.tb=dS;_.vb=eS;_.tN=wO+'UIObjectConnector';_.tI=149;_.b=null;var iS;function DR(){DR=eO;aS();}
function CR(b,a,c){DR();b.a=c;FR(b,a);return b;}
function ER(){return this.a;}
function BR(){}
_=BR.prototype=new AR();_.ib=ER;_.tN=wO+'UIObjectConnector$1';_.tI=150;function sS(e,a){a=a.replace(/[\[]/,'\\[').replace(/[\]]/,'\\]');var c='[\\?&]'+a+'=([^&#]*)';var b=new RegExp(c);var d=b.exec($wnd.location.href);if(d==null)return '';else return d[1];}
function tS(a){lh(new kS());gm(oS(new nS(),a));}
function jS(){}
_=jS.prototype=new mG();_.tN=xO+'BaseExamplesEntryPoint';_.tI=151;function mS(e,f){var a,b,c,d;d='Uncaught exception: ';while(f!==null){c=f.c;d+=EH(f)+'\n';for(b=0;b<c.a;b++){d+='    at '+c[b]+'\n';}f=f.a;if(f!==null){d+='Caused by: ';}}a=ns(new ls(),true);Fl(a.lb(),'backgroundColor','#ABCDEF');vH(),xH;d=hH(d,' ','&nbsp;');qs(a,'<pre>'+d+'<\/pre>');Fx(a);}
function kS(){}
_=kS.prototype=new mG();_.tN=xO+'BaseExamplesEntryPoint$1';_.tI=152;function oS(b,a){b.a=a;return b;}
function qS(){BS(this.a);}
function nS(){}
_=nS.prototype=new mG();_.db=qS;_.tN=xO+'BaseExamplesEntryPoint$2';_.tI=153;function BS(c){var a,b;b=EA(new rA());nq(dz('tabs'),b);aB(b,eV(new dV()),'Rectilinear');aB(b,CT(new BT()),'Bezier');aB(b,iV(new hV()),'Straight');aB(b,wU(new FT()),'Diagram builder');FA(b,wS(new vS(),c,b));a=sS(c,'tab');if(a===null||cH('',a)){a='0';}fB(b,sF(a));}
function uS(){}
_=uS.prototype=new jS();_.tN=xO+'GwtDiagramsExample';_.tI=154;function wS(b,a,c){b.a=c;return b;}
function yS(a,b){return true;}
function zS(b,c){var a;a=qi(cB(this.a,c),43);tT(a);}
function vS(){}
_=vS.prototype=new mG();_.dc=yS;_.xc=zS;_.tN=xO+'GwtDiagramsExample$1';_.tI=155;function xT(a){a.i=mq(new lq());}
function yT(a){var b;nz(a);xT(a);lB(a,'gwt-diagrams-example');b=fC(new dC());pz(a,b);gC(b,a.i);gC(b,AT(a,sT(a)));return a;}
function AT(e,d){var a,b,c;a=ht(new gt());lB(a,'gwt-diagrams-sources-panel');for(b=zI(d);oI(b);){c=qi(pI(b),14);it(a,c);}return a;}
function wT(){}
_=wT.prototype=new gz();_.tN=yO+'AbstractExample';_.tI=156;function lT(a){a.g=pK(new nK());}
function mT(a){yT(a);lT(a);a.h=qT(a);Fl(a.i.lb(),'width','450px');Fl(a.i.lb(),'height','350px');a.E();return a;}
function nT(b,a){nq(b.i,a);rK(b.g,a);}
function pT(e,d,c,f,a){var b;b=Fw(new Dw(),d);lB(b,'example-connector');oq(e.i,b,c,f);aT(e.h,b);if(a!==null){return hS(b,li('[Lpl.balon.gwt.diagrams.client.connector.Direction;',174,37,[a]));}return gS(b);}
function qT(b){var a;a=ES(new DS(),b.i,true,b);return a;}
function rT(b,a){BK(b.g,a);}
function sT(f){var a,b,c,d,e;e=pK(new nK());b=fH(jh(f),46);a=iH(jh(f),b+1);rK(e,sw(new qw(),a+'.java',''));rK(e,sw(new qw(),'AbstractExample.java',''));rK(e,sw(new qw(),'AbstractConnectionsExample.java',''));for(d=zI(e);oI(d);){c=qi(pI(d),44);lB(c,'gwt-diagrams-source-link');tw(c,iT(new hT(),f,c));}return e;}
function tT(c){var a,b;for(b=zI(c.g);oI(b);){a=qi(pI(b),41);a.hd();}}
function uT(a){nT(this,a);}
function vT(){var a,b,c,d,e,f,g,h;a=pT(this,'all',50,50,null);b=pT(this,'all',100,100,null);this.A(a,b);c=pT(this,'up',250,50,(sR(),xR));d=pT(this,'down',300,100,(sR(),uR));this.A(c,d);e=pT(this,'left',50,200,(sR(),vR));f=pT(this,'right',100,250,(sR(),wR));this.A(e,f);g=pT(this,'left',250,200,(sR(),vR));h=pT(this,'left',300,250,(sR(),vR));this.A(g,h);}
function CS(){}
_=CS.prototype=new wT();_.t=uT;_.E=vT;_.tN=yO+'AbstractConnectionsExample';_.tI=157;_.h=null;function FS(){FS=eO;ad();}
function ES(d,a,b,c){FS();Fc(d,a,b);return d;}
function aT(a,b){A(a,b);Fl(b.lb(),'position','absolute');Fl(b.lb(),'zIndex','100');}
function bT(a){aT(this,a);}
function cT(b,a){return eT(new dT(),b,a,this);}
function DS(){}
_=DS.prototype=new Ec();_.Db=bT;_.Fb=cT;_.tN=yO+'AbstractConnectionsExample$1';_.tI=158;function fT(){fT=eO;se();}
function eT(d,a,b,c){fT();re(d,a,b);return d;}
function gT(d,c,b){var a;od(this,d,c,b);a=fS(c);if(a!==null){jR(a);}}
function dT(){}
_=dT.prototype=new qe();_.tc=gT;_.tN=yO+'AbstractConnectionsExample$2';_.tI=159;function iT(b,a,c){b.a=c;return b;}
function kT(a){bo('../source/'+vw(this.a),'','');}
function hT(){}
_=hT.prototype=new mG();_.fc=kT;_.tN=yO+'AbstractConnectionsExample$3';_.tI=160;function CT(a){mT(a);return a;}
function ET(a,b){this.t(qP(new oP(),a,b));}
function BT(){}
_=BT.prototype=new CS();_.A=ET;_.tN=yO+'BezierExample';_.tI=161;function vU(a){a.c=pK(new nK());}
function wU(a){mT(a);vU(a);return a;}
function xU(b,a){nT(b,a);lP(a);}
function zU(c,a,b){if(cH('rectilinear',c.d)){xU(c,zP(new xP(),a,b));}else if(cH('bezier',c.d)){xU(c,qP(new oP(),a,b));}else if(cH('straight',c.d)){xU(c,aQ(new FP(),a,b));}}
function AU(e,d,c){var a,b;b=nU(new mU(),dx(d),e);uB(b,d.rb(),d.qb());lB(b,'example-connector');oq(c,b,nB(d)-nB(c),oB(d)-oB(c));aT(e.h,b);a=null;if(cH('T',dx(b))){a=(sR(),xR);}else if(cH('L',dx(b))){a=(sR(),vR);}else if(cH('B',dx(b))){a=(sR(),uR);}else if(cH('R',dx(b))){a=(sR(),wR);}if(a!==null){return hS(b,li('[Lpl.balon.gwt.diagrams.client.connector.Direction;',174,37,[a]));}return gS(b);}
function BU(c,a){var b;b=Fw(new Dw(),a);lB(b,'helpEntry');jw(c.a,b);}
function CU(d,c,a){var b;b=yy(new wy(),'style',c);lB(b,'style-option');cr(b,a);if(a){FU(d,c);}jw(d.e,b);nt(b,jU(new iU(),d,c));return b;}
function DU(d,a,c){var b;b=Fw(new Dw(),a);vB(b,'toolbox-node');lB(b,c);jw(d.e,b);d.f.Db(b);return b;}
function EU(d,e){var a,b,c,f;if(zK(d.c)){lB(e,'selected-connector');b=fS(e).c;for(c=tN(b);mJ(c);){a=qi(nJ(c),41);a.Cc();rT(d,a);}rK(d.c,e);}else if(vK(d.c,e)){rB(e,'selected-connector');BK(d.c,e);}else if(d.c.b==1){f=qi(wK(d.c,0),14);rB(e,'selected-connector');rB(f,'selected-connector');b=fS(e).c;for(c=tN(b);mJ(c);){a=qi(nJ(c),41);a.Cc();rT(d,a);}zU(d,fS(f),fS(e));tK(d.c);}}
function FU(b,a){b.d=a;}
function aV(a){xU(this,a);}
function bV(a,b){zU(this,a,b);}
function cV(){var a,b,c;a=Fc(new Ec(),this.i,true);b=jd(new id(),this.i);this.f=sU(new qU(),b,a,this);this.e=iw(new gw());vB(this.e,'toolbox');this.b=mq(new lq());this.a=iw(new gw());vB(this.a,'helpPanel');c=fC(new dC());vB(c,'builder');gC(c,this.a);gC(c,this.e);gC(c,this.b);nq(this.i,c);DU(this,'A','all');DU(this,'L','left');DU(this,'R','right');DU(this,'T','top');DU(this,'B','bottom');CU(this,'rectilinear',true);CU(this,'bezier',false);CU(this,'straight',false);BU(this,'drag&drop from toolbar to add');BU(this,'CTRL+click to select/connect');BU(this,'DEL to delete selected');ck(fU(new eU(),this));}
function FT(){}
_=FT.prototype=new CS();_.t=aV;_.A=bV;_.E=cV;_.tN=yO+'DiagramBuilderExample';_.tI=162;_.a=null;_.b=null;_.d=null;_.e=null;_.f=null;function bU(b,a,c){b.a=a;b.b=c;return b;}
function dU(a){var b,c,d;b=a.d;d=qi(CM(this.a.a,b),14);c=this.b.g;AU(this.a.b,qi(d,45),c);throw gd(new fd());}
function aU(){}
_=aU.prototype=new rb();_.uc=dU;_.tN=yO+'DiagramBuilderExample$1';_.tI=163;function fU(b,a){b.a=a;return b;}
function hU(a){var b,c;if(128==Fk(a)&&46==Ak(a)&& !zK(this.a.c)){for(b=AI(this.a.c);oI(b);){c=qi(pI(b),14);qI(b);DC(c);}return false;}return true;}
function eU(){}
_=eU.prototype=new mG();_.lc=hU;_.tN=yO+'DiagramBuilderExample$2';_.tI=164;function jU(b,a,c){b.a=a;b.b=c;return b;}
function lU(a){FU(this.a,this.b);}
function iU(){}
_=iU.prototype=new mG();_.fc=lU;_.tN=yO+'DiagramBuilderExample$3';_.tI=165;function nU(c,a,b){c.a=b;Fw(c,a);return c;}
function pU(a){if(Fk(a)==1&&yk(a)){EU(this.a,this);}ex(this,a);}
function mU(){}
_=mU.prototype=new Dw();_.ec=pU;_.tN=yO+'DiagramBuilderExample$4';_.tI=166;function tU(){tU=eO;ad();}
function rU(a){a.a=wM(new AL());}
function sU(d,a,b,c){tU();d.b=c;Fc(d,d.b.i,false);rU(d);dd(d,true);F(d,a);u(d,bU(new aU(),d,a));return d;}
function uU(a){var b,c;b=qi(a,45);c=Fw(new Dw(),dx(b));lB(c,'dragdrop-proxy');lB(c,'toolbox-node-proxy');uB(c,b.rb(),b.qb());DM(this.a,b,c);return c;}
function qU(){}
_=qU.prototype=new Ec();_.Eb=uU;_.tN=yO+'DiagramBuilderExample$ToolboxDragController';_.tI=167;function eV(a){mT(a);return a;}
function gV(a,b){this.t(zP(new xP(),a,b));}
function dV(){}
_=dV.prototype=new CS();_.A=gV;_.tN=yO+'RectilinearExample';_.tI=168;function iV(a){mT(a);return a;}
function kV(c,a,b){c.t(aQ(new FP(),a,b));}
function lV(a,b){kV(this,a,b);}
function mV(){var a,b;a=pT(this,'connector 1',50,50,(sR(),xR));b=pT(this,'connector 2',200,200,(sR(),uR));kV(this,a,b);}
function hV(){}
_=hV.prototype=new CS();_.A=lV;_.E=mV;_.tN=yO+'StraightConnectionsExample';_.tI=169;function cE(){tS(new uS());}
